...
class QAState(TypedDict, total=False):
    ...
    # Compact, consolidated planning view rebuilt after every tool call. Planners
    # orient on this first so decisions stay coherent instead of re-deriving
    # conclusions from scattered raw evidence each turn.
